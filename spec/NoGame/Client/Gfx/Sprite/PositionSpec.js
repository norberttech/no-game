...
describe("Gfx Size", () => {
    it("throws error when created from invalid values", () => {
        ...
        expect(() => {new Position("string", 0)}).toThrow('Expected integer but got "string["string"]".');
        expect(() => {new Position(10, "string")}).toThrow('Expected integer but got "string["string"]".');
    });
});