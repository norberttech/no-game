describe("Area", () => {
    ...
    it ("throws error on attempt to spawn same player twice", () => {
        let area = new Area("test area", 10, 10);
        let player = new Player("1111", "yaboomaster", 0, 100, 100, new Position(0, 0), new Position(0, 0));
    ...
    it ("returns players except player with specific ID", () => {
        ...
        let player1 = new Player("111", "yaboo1", 0, 100, 100, new Position(1, 1), new Position(1, 1));
        let player2 = new Player("222", "yaboo2", 0, 100, 100, new Position(1, 1), new Position(1, 1));
    ...
    it ("returns tiles visible by player", () => {
        ...
        let player = new Player("1111", "yaboo1", 0, 100, 100, new Position(50, 50), new Position(50, 50));
        for (let x = 0; x < 100; x++) {
            for (let y = 0; y < 100; y++) {
