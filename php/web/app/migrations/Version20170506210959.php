...
class Version20170506210959 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE nogame_character (id UUID NOT NULL, account_id UUID NOT NULL, name VARCHAR(255) NOT NULL, normalized_name VARCHAR(255) NOT NULL, health INT NOT NULL, experience INT NOT NULL, PRIMARY KEY(id))');
